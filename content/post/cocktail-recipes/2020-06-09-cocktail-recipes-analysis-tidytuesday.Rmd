...
For this first blog post I thought I'd take a recent #TidyTuesday dataset and do some analysis of it. Where better to start than one of my favourite things? Cocktails! I enjoyed watching Julia Silge and David Robinson analysing this particular dataset, and I've taken some of their ideas in this post, so they deserve acknowledgement. 

I will first clean the data, do some exploratory analysis, then apply some unsupervised learning techniques to look for patterns.
...
Look at entries 2, 13 and 17. It's all lemon juice with different names! We need to do some data cleaning...
