...
Let's take another look at the most commong ingredients, this time as graph:
...
This is a nice plot! As before, we see popular combinations of ingredients (e.g. whiskey/bitters, gin/vermouth, lemon juice/sugar) but now we can see the full picture. If in doubt as to what kind of drink to make next time you're hosting a party this might be a good starting point!

Unsurprisingly the spirits tend to be quite far apart (except for gin and brandy) and surrounded by flavouring agents such as juices and soft liqueurs. The bluer colour of the spirits show that they tend to be earlier in the drink recipes.
...
> "When faced with a large set of correlated variables, PCA allow us to summarize this set with a smaller number of representative variables that collectively explain most
of the variability in the original set...PCA also serves as a tool for data visualization."
`r tufte::quote_footer('--- An Introduction to Statistical Learning, by James/Witten/Hastie/Tibshirani')`
...
* Cocktails are all about classic combinations of ingredients: gin with vermouth; citrus with egg and sugar; rum with lime; whiskey with bitters...
* Out of the spirits, tequila and vodka are considered the least 'classic' as ingredients for cocktails.  



```{r}
# cocktails_parsed %>%
#    filter(category == "Cocktail Classics", ingredient == "tequila") %>%
#    distinct(name) %>%
#    count()
#
# cocktails_parsed %>%
#    filter(category == "Cocktail Classics", ingredient == "gin") %>%
#    distinct(name) %>%
#    count()
#
# cocktails_parsed %>%
#    filter(category == "Cocktail Classics", ingredient == "whiskey") %>%
#    distinct(name) %>%
#    count()
#
# cocktails_parsed %>%
#    filter(category == "Cocktail Classics", ingredient == "vodka") %>%
#    distinct(name) %>%
#    count()
#
# cocktails_parsed %>%
#    filter(category == "Cocktail Classics", ingredient == "brandy") %>%
#    distinct(name) %>%
#    count()
#
# cocktails_parsed %>%
#    filter(category == "Cocktail Classics", ingredient == "rum") %>%
#    distinct(name) %>%
#    count()
```
